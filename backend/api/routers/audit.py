...
def list_audit(
    ...
    user_id: Optional[str] = Query(None, description="Filter by user or buyer"),
    ...
    try:
        ...
        query_sql = f"""
            SELECT audit_id, txn_id, action, triggered_by, reasoning, created_at
            FROM audit_log
            {where_clause}
