...
# ---------------------------------------------------------------------------
# Pattern mirrors the existing seed_data.sql so the dev DB stays readable:
#   b0000000-0000-4000-8000-XXXXXXXXXXXX  → buyers
#   d0000000-0000-4000-8000-XXXXXXXXXXXX  → devices
#   e0000000-0000-4000-8000-XXXXXXXXXXXX  → transactions
# We offset past the seed range (60/75/520) so generated data doesn't clash.
SEED_BUYER_COUNT = 60
...
def gen_transactions(
    ...
    for batch in chunked(range(SEED_TXN_COUNT + 1, SEED_TXN_COUNT + 1 + count), BATCH):
        params = []
        for i in batch:
