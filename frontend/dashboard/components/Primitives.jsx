...
export function ScoreBar({ value, allowThreshold = 45, challengeThreshold = 75 }) {
  const pct = Math.max(0, Math.min(100, value))
  const color = pct >= challengeThreshold ? 'var(--risk-block)' : pct >= allowThreshold ? 'var(--risk-challenge)' : 'var(--risk-allow)'
  return (
    <div
      role="progressbar"
      aria-valuenow={pct}
