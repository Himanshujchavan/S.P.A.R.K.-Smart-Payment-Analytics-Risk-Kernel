...
export default function SimulationPage() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      const p50 = null, p95 = null, p99 = null
          ...
          {run && (
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 8 }}>
                ...
                <StatTile label="p50" value={stats?.p50 == null ? '—' : stats.p50.toFixed(0) + ' ms'} hint="scoring latency" />
                <StatTile label="p95" value={stats?.p95 == null ? '—' : stats.p95.toFixed(0) + ' ms'} hint="scoring latency" />
                <StatTile label="p99" value={stats?.p99 == null ? '—' : stats.p99.toFixed(0) + ' ms'} hint="scoring latency" />
              </div>
            </div>
          )}
        </Card>
